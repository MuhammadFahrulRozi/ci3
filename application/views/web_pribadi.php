...
<header>
    ...
    <div class="bannerText">
        <h1>I'm Muhammad Fahrul Rozi</h1>
    	...
    	<div class="row">
            ...
            <div class="col-md-12">
            	<div class="col-md-6 col-sm-12 media">
                	<p>Dan pada blog ini saya akan menginformasikan hal-hal yang saya suka dan hobi apa saja saya suka. Saya memiliki hobi game salah satunya game Mobile Legends yang lagi Buming saat ini. Lalu saya paling suka mendaki gunung. Dan saya juga memberi persentase seberapa persen yang saya sukai. jika ingin lihat di click aja langsung yak :D</p>
                </div>
            	<div class="col-md-6 col-sm-12">                
                <div class="skillbar clearfix " data-percent="94%">
                    <div class="skillbar-title"><button type="button" class="btn btn-info"><a href="ml.php"><span>Mobile Legends</span></div></button>
                    <div class="skillbar-bar"></div>
                    <div class="skill-bar-percent"></div>
                </div> <!-- End Skill Bar -->
                
                <div class="skillbar clearfix " data-percent="86%">
                    <div class="skillbar-title"><button type="button" class="btn btn-info"><a href="hiking.php">Hiking</div></button>
                    <div class="skillbar-bar"></div>
                    <div class="skill-bar-percent"></div>
                </div> <!-- End Skill Bar -->
                
                <div class="skillbar clearfix " data-percent="41%">
                    <div class="skillbar-title"><button type="button" class="btn btn-info"><a href="anime.php"><span>Film Anime<span></div></button>
                    <div class="skillbar-bar"></div>
                    <div class="skill-bar-percent"></div>
                </div> <!-- End Skill Bar -->
